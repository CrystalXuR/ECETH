...
slasso_surv = function(x, w, y, D, times,
  ...
  standardization = caret::preProcess(x_all1, method=c("center", "scale")) 
  x_scl_1 = predict(standardization, x_all1)						
  ...
  standardization = caret::preProcess(x_all0, method=c("center", "scale")) 
  x_scl_0 = predict(standardization, x_all0)							 
...
predict.slasso_surv <- function(object,
  ...
  if (!is.null(newx)) {
    ...
    x_scl_1 = predict(standardization, x_all1)						
    x_scl_1 = x_scl_1[,!is.na(colSums(x_scl_1)), drop = FALSE]
    newx_scl_pred1 = cbind(0.5, x_scl_1)
    ...
    x_scl_0 = predict(standardization, x_all0)							 
    x_scl_0 = x_scl_0[,!is.na(colSums(x_scl_0)), drop = FALSE]
    newx_scl_pred0 = cbind(-0.5, x_scl_0)
